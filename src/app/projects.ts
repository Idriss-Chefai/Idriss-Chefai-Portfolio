...
export const PROJECTS: Project[] = [
  // --- 2026: PINNED / RECENT HIGHLIGHTS (GAMES & HACKATHON) ---
  {
    ...
    media: [{ type: "image", thumb: "/assets/thumbnails/voidrunner.png", label: "Gameplay Showcase" }],
  },
  {
    id: 2,
    name: "RUST & RUN",
    ...
    media: [{ type: "image", thumb: "/assets/thumbnails/game_online.png", label: "Network Debugger" }],
  },
  {
    id: 3,
    name: "The Reset",
  ...
  {
    id: 5,
    name: "AI Ad Award Hackathon 🇹🇳",
    cat: ["AI", "Web"],
    role: "Full-Stack Engineer",
    period: "2026",
    highlights: [
      "Assembled a swift project integration workflow managing automated prompts for video generation pipelines",
      "Constructed responsive dashboards for tracking active model rendering states and multi-user queue priorities",
      "Deployed REST interfaces bridging direct API requests to remote cloud inference endpoints",
    ],
    tech: ["Node.js", "Python", "React", "Firebase"],
    media: [{ type: "image", thumb: "/assets/thumbnails/ai_hackathon.png", label: "Generation Feed" }],
  },
  {
    id: 6,
  ...
  },
  {
    ...
    highlights: [
      "Modeled detailed low-poly stylized character assets keeping geometry optimized for realtime deployment",
      "Rigged structural vertex weight groups and skeletal constraints to achieve clean, natural organic deformations",
      "Authored fluid cycle clips covering complex combat, locomotion, and systemic level interactions",
    ],
